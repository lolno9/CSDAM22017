...
public class SearchNearByPlaces extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,LocationListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.addMarker(new MarkerOptions().position(cero).title("Posicio actual").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
...
//AKIII
    public void findPlaces(String placeType){
        Call<NearByApiResponse> call = MyApplication.getApp().getApiService().getNearbyPlaces(placeType, 41.602427+","+0.586540/*location.getLatitude() + "," + location.getLongitude()*/, PROXIMITY_RADIUS);
